...
/**
 * This class encrypts the secretKey with the client's public key and encrypts data files
 * with the secretKey.
 */
public class StartEncryption
{
		...
		throws IOException, GeneralSecurityException, Exception
	{
		...
		new EncryptKey(startEnc.getPublic("KeyPair/publicKey_ClientA", "RSA"),
			originalKeyFile, encryptedKeyFile, "RSA");

		File originalFile = new File("OriginalFiles/testfile.txt");
