...
/**
 * This class decrypts the encryptedSecretKey with the client's private key and then decrypts the files
 * with the decrypted secretKey.
 */
public class StartDecryption
{
	...
	public static void main(String[] args) throws IOException, GeneralSecurityException, Exception
	{
		...
		new DecryptKey(startEnc.getPrivate("KeyPair/privateKey_ClientA", "RSA"),
			encryptedKeyReceived, decreptedKeyFile, "RSA");

		File encryptedFileReceived = new File("EncryptedFiles/encryptedFile");
		File decryptedFile = new File("DecryptedFiles/decryptedFile.txt");
